...
public class ToDos extends MultiDetail {
    ...
    public void init() {
        ...
        this.AttorneyFee.setDbType("int");
    ...
    public String printMaintainTable() throws Exception {
        ...
        if (this.onMaintainMode()) {
            ...
            this.LegalDueDate.setAnotherField(this.AttorneyDueDate);
            ...
            this.Currency.setAnotherField(this.Points);
	...
	public String printSearchReasult() throws Exception {
		...
		strBfr.append(newLine + "<tr"+this.getThBgcolor()+">"+thText1+thText2+thText3+
									thText4+thText5+thText6+thText7+thText10+thText8+thText9+"</tr>");
		...
		for(Iterator itr=findList.iterator();itr.hasNext();i++){
			...
			printValue = tdText1+tdText2+tdText3+tdText4+tdText5+tdText6+tdText10+tdText7+tdText8+tdText9;
			if(i%2==0){
    ...
    public List<List<Field>> getNotFinishedList(String empId, UserBean userInfo) throws Exception{
    	String SQL = "select 'ToDos' as LinkPage1, t.FlowKey as LinkFlowKey1, "+
    				 ...
    				 "inner join Category cc on t.Matter=cc.FlowKey "+
