...
public class PatentDocument extends MultiDetail {

    public PatentDocument(){this.init();}

    public PatentDocument(String FlowKey) {
        this.init();
    ...
    public void init() {
        super.init();
        this.setProgramId("jsp.PatentDocument");
        this.setTableName("PatentDocument");
    ...
    public void setPreObj(UserBean userInfo){
        if (userInfo.getObj(this.getTableName()) != null) {
            PatentDocument preObj = (PatentDocument) userInfo.getObj(this.getTableName());
