...
public class PatentAttorney extends MultiDetail {

    public PatentAttorney(){this.init();}

    public PatentAttorney(String FlowKey) {
        this.init();
    ...
    public void init() {
        super.init();
        this.setProgramId("jsp.PatentAttorney");
        this.setTableName("PatentAttorney");
    ...
    public void setPreObj(UserBean userInfo){
        if (userInfo.getObj(this.getTableName()) != null) {
            PatentAttorney preObj = (PatentAttorney) userInfo.getObj(this.getTableName());
