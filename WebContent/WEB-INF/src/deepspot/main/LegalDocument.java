...
public class LegalDocument extends MultiDetail {

    public LegalDocument(){this.init();}

    public LegalDocument(String FlowKey) {
        this.init();
    ...
    public void init() {
        super.init();
        this.setProgramId("jsp.LegalDocument");
        this.setTableName("LegalDocument");
    ...
    public void setPreObj(UserBean userInfo){
        if (userInfo.getObj(this.getTableName()) != null) {
            LegalDocument preObj = (LegalDocument) userInfo.getObj(this.getTableName());
	...
	public String printSearchReasult() throws Exception {
		...
		String thText2="<td align='center' width='10%'>"+this.getUserInfo().getMsg("jsp.LegalDocument.DocumentType")+"</td>";
		String thText3="<td align='center' width='30%'>"+this.getUserInfo().getMsg("jsp.LegalDocument.DocumentName")+"</td>";
		String thText4="<td align='center' width='10%'>"+this.getUserInfo().getMsg("jsp.LegalDocument.DocumentNo")+"</td>";
		String thText5="<td align='center' width='10%'>"+this.getUserInfo().getMsg("jsp.LegalDocument.DocumentDate")+"</td>";
		String thText6="<td align='center' width='10%'>"+this.getUserInfo().getMsg("jsp.LegalDocument.DocumentKind")+"</td>";
		String thText7="<td align='center' width='10%'>"+this.getUserInfo().getMsg("jsp.LegalDocument.DocumentTarget")+"</td>";
		String thText8="<td align='center' width='10%'>"+this.getUserInfo().getMsg("jsp.LegalDocument.DocumentProcess")+"</td>";
		String thText9="<td align='center' width='10%'>"+this.getUserInfo().getMsg("jsp.LegalDocument.DocumentUrl")+"</td>";
