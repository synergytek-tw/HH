...
public class PatentPriority extends MultiDetail {

    public PatentPriority(){this.init();}

    public PatentPriority(String FlowKey) {
        this.init();
    ...
    public void init() {
        super.init();
        this.setProgramId("jsp.PatentPriority");
        this.setTableName("PatentPriority");
    ...
    public void setPreObj(UserBean userInfo){
        if (userInfo.getObj(this.getTableName()) != null) {
        	PatentPriority preObj = (PatentPriority) userInfo.getObj(this.getTableName());
