...
public class PatentApplicant extends MultiDetail {

    public PatentApplicant(){this.init();}

    public PatentApplicant(String FlowKey) {
        this.init();
    ...
    public void init() {
        super.init();
        this.setProgramId("jsp.PatentApplicant");
        this.setTableName("PatentApplicant");
    ...
    public void setPreObj(UserBean userInfo){
        if (userInfo.getObj(this.getTableName()) != null) {
            PatentApplicant preObj = (PatentApplicant) userInfo.getObj(this.getTableName());
	...
	public String printSearchReasult() throws Exception {
		...
		String thText2="<td align='center' width='5%'>"+this.getUserInfo().getMsg("jsp.PatentApplicant.ApplicantOrder")+"</td>";
		...
		String SQL = "select pa.FlowKey as ApplicantId, pa.ApplicantOrder, a.* "+
					 "from PatentApplicant pa inner join Applicant a "+
