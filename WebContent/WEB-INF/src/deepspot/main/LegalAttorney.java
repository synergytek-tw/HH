...
public class LegalAttorney extends MultiDetail {

    public LegalAttorney(){this.init();}

    public LegalAttorney(String FlowKey) {
        this.init();
    ...
    public void init() {
        super.init();
        this.setProgramId("jsp.LegalAttorney");
        this.setTableName("LegalAttorney");
    ...
    public String printMaintainTable() throws Exception {
        ...
        if (this.onMaintainMode()) {
            ...
            this.AttorneyName.setButtonValue(this.getUserInfo().getMsg("jsp.LegalAttorney.QueryAttorney"));
    ...
    public void setPreObj(UserBean userInfo){
        if (userInfo.getObj(this.getTableName()) != null) {
            LegalAttorney preObj = (LegalAttorney) userInfo.getObj(this.getTableName());
	...
	public String printSearchReasult() throws Exception {
		...
		String thText2="<td align='center' width='10%'>"+this.getUserInfo().getMsg("jsp.LegalAttorney.AttorneyType")+"</td>";
		...
		for(Iterator itr=findList.iterator();itr.hasNext();i++){
			...
			String onClick = " onClick='openAppendix(\"Attorney.jsp?flowKey="+FlowKey+
			  					...
			  					"\",\"LegalApplicant\",800,600)' style='cursor:hand'";
