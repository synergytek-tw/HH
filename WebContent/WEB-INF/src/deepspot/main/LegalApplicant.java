...
public class LegalApplicant extends MultiDetail {

    public LegalApplicant(){this.init();}

    public LegalApplicant(String FlowKey) {
        this.init();
    ...
    public void init() {
        super.init();
        this.setProgramId("jsp.LegalApplicant");
        this.setTableName("LegalApplicant");
    ...
    public String printMaintainTable() throws Exception {
        ...
        if (this.onMaintainMode()) {
    		...
    		String SQL="select * from Legalcase"+
    					whereStr;
            ...
            this.ApplicantName.setButtonValue(this.getUserInfo().getMsg("jsp.LegalApplicant.QueryApplicant"));
    ...
    public void setPreObj(UserBean userInfo){
        if (userInfo.getObj(this.getTableName()) != null) {
            LegalApplicant preObj = (LegalApplicant) userInfo.getObj(this.getTableName());
	...
	public String printSearchReasult() throws Exception {
		...
		String thText2="<td align='center' width='5%'>"+this.getUserInfo().getMsg("jsp.LegalApplicant.ApplicantOrder")+"</td>";
		...
		String SQL = "select pa.FlowKey as ApplicantId, pa.ApplicantOrder, a.* "+
					 "from LegalApplicant pa inner join Applicant a "+
