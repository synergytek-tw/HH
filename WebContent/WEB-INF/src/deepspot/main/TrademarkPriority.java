...
public class TrademarkPriority extends MultiDetail {

    public TrademarkPriority(){this.init();}

    public TrademarkPriority(String FlowKey) {
        this.init();
    ...
    public void init() {
        super.init();
        this.setProgramId("jsp.TrademarkPriority");
        this.setTableName("TrademarkPriority");
    ...
    public void setPreObj(UserBean userInfo){
        if (userInfo.getObj(this.getTableName()) != null) {
        	TrademarkPriority preObj = (TrademarkPriority) userInfo.getObj(this.getTableName());
	...
	public String printSearchReasult() throws Exception {
		...
		String thText2="<td align='center' width='15%'>"+this.getUserInfo().getMsg("jsp.PatentPriority.Country")+"</td>";
		String thText3="<td align='center' width='15%'>"+this.getUserInfo().getMsg("jsp.PatentPriority.PriorityDate")+"</td>";
		String thText4="<td align='center' width='15%'>"+this.getUserInfo().getMsg("jsp.PatentPriority.ApplyNo")+"</td>";
		String thText5="<td align='center' width='15%'>"+this.getUserInfo().getMsg("jsp.PatentPriority.CaseNo")+"</td>";
		String thText6="<td align='center' width='40%'>"+this.getUserInfo().getMsg("jsp.PatentPriority.Document")+"</td>";
