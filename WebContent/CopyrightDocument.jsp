...
<jsp:useBean id="thisObj" scope="page" class="deepspot.main.CopyrightDocument"/>
...
%>
	<script>
	parent.resetFrame('CopyrightToDos');
    </script>
<%
	}
	else {
%>
    <script>
      ...
      parent.resetFrame('CopyrightToDos');
      parent.resetTodosTab('CopyrightCase', '<%=thisObj.getParentId()%>');
    </script>
<%
	}
}
